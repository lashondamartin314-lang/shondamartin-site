...
const CARDS = [
  ...
  { id: 209, section: 'bureau', catLabel: 'Bureau Response', title: 'Suspected credit repair organization', cite: 'The CRO accusation', citeSummary: 'The bureau accuses you of using a credit repair company and dismisses your dispute on that basis.', hook: 'They accuse you of using credit repair. The dispute is still valid.', whenToUse: ['When a dispute response references suspected CRO involvement', 'When dispute language is dismissed as "templated"', 'When you are doing 100% DIY and being treated as a CRO client'], facts: 'Bureaus have no legal authority to dismiss a dispute solely because they suspect a CRO is involved. FCRA § 1681i obligates investigation regardless.', watchOut: 'This response is designed to discourage you. Disputing your own report is your federal right under FCRA.', teaching: 'Respond plainly: state you are personally disputing items under FCRA § 1681i, that no third party prepared the dispute, and demand they proceed.', mockLetter: 'cro' },
  ...
  // ====== PROCESS ======
  { id: 301, section: 'process', catLabel: 'Process', title: 'The 6-Phase DIY journey', cite: 'The Credit Academy Dispute Playbook', citeSummary: 'The step-by-step DIY credit repair process, broken into six phases.', hook: 'Personal info → Round 1-2 → Final dispute → CFPB → Substantive → Cleanup.', whenToUse: ['When orienting a new member', 'When mapping where someone is stuck', 'When teaching what comes next after each phase', 'When designing course content'], facts: 'Phase 1: Personal Info Cleanup. Phase 2: Round 1+2. Phase 3: Final Bureau Disputes. Phase 4: External Complaints + Legal Action. Phase 5: Substantive Challenges. Phase 6: Prevent New Collections.', watchOut: 'Skipping Phase 1 is the most common mistake. Without it, every subsequent dispute has weaker legal standing.', teaching: 'The phases are not parallel. They are sequential. Members who try to compress them lose leverage and waste rounds.' },
